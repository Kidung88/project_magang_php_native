...
?>
  <head>
    <title>Halo, <?php echo $data['fullname']; ?> - PUSINFOLAHTA TNI</title>
    <meta charset="utf-8">
      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          <div class="user-panel">
            <div class="pull-left image"><img class="img-responsive" src="../assets/images/logo-mabes.png" alt="User Image"></div>
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <legend>Aplikasi Enkripsi dan Dekripsi PUSINFOLAHTA TNI</legend>
                <p>Di era ini teknologi yang semakin maju dan pesat, dimana kerahasiaan data salah satunya yang sangat penting bagi sebuah lembaga pemerintahan.<br>
                  Oleh karena itu, maka dibuatlah Aplikasi Enkripsi dan Dekripsi untuk keamanan file. <br>
                  Aplikasi ini merupakan Aplikasi untuk menjaga kerahasiaan data-data penting di PUSINFOLAHTA TNI</p>
              </div>
            </div>
          </div>
        </div>
