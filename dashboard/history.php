    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-dashboard"></i> History Data Enkripsi dan Dekripsi PUSINFOLAHTA TNI</h1>
          </div>
          <div>
            <ul class="breadcrumb">
                    ...
                    <thead>
                        ...
                        <?php
                          ...
                          <tr>
                            ...
                            <?php
                              $a = $data['id_file'];
                                echo '<a href="delete-file.php?id_file='.$a.'" class="btn btn-danger">Delete</a>';
                              ?>
                            </td>
                          </tr>
                          <?php
